 ...
 */
 ...
 /* SynthControl */
 asmlinkage long sys_print_msg(char* msg, int len);
 asmlinkage long sys_append_int(char* msg, int in);
 asmlinkage long sys_append_int64(char* msg, long long in);
 asmlinkage long sys_append_double(char* msg, double in);
 asmlinkage long sys_append_float(char* msg, float in);
 asmlinkage long sys_append_string(char* msg, char* in);
 asmlinkage long sys_append_char(char* msg, char len);
 asmlinkage long sys_append_color(char* msg, char r, char g, char b, char a);
 asmlinkage long sys_append_bool(char* msg, int in);
 asmlinkage long sys_append_nil(char* msg);
 asmlinkage long sys_append_infinitum(char* msg);
 ...
 asmlinkage long sys_send_msg(char* host, int* port, char* address, char* msg, int msglen);